...
# Prerequisites
  ...
  - [Docker GitLab](https://github.com/jlospinoso/docker-gitlab) >= 8.8.5-1
...
For more info look at [Available Configuration Parameters](https://github.com/jlospinoso/docker-gitlab#available-configuration-parameters).
...
services:
  ...
  postgresql:
    restart: always
    image: jlospinoso/postgresql:9.4-23
    volumes:
  ...
  gitlab:
    restart: always
    image: jlospinoso/gitlab:8.9.6-1
    depends_on:
    - redis
    - postgresql
    ports:
